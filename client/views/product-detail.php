...
<div class="content">
    ...
    <div class="content-product-info_box padding-container">
        ...
        <div class="content-product-info_right">
            ...
            <div class="tabs1">
                <div class="tab-item active tablinks" <?= !isset($isDanhgia)  ?  'id="defaultOpen"' : '' ?> onclick="openCity(event, 'London')">Mô tả
                </div>
                    ...
                    <form action="?url=binh-luan" method="POST" class="form-cmtt">
                        ...
                        <div class="form-control-cmtt">
                            ...
                            <div class="form-control-input-box">
                                <input class="form-control-input" name="content" type="text" placeholder="Đánh giá của bạn ...">
