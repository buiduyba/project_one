...
<head>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0" nonce="vWDw95v7"></script>
    ...
    <div class="container">
        <header class="header">
            <div class="header-top">
                <marquee behavior="" direction="">Jevilor chuyên thời trang cao cấp. Sự lựa chọn tối ưu dành cho bạn!</marquee>
            </div>
            <div class="header-main padding-container">
                ...
                <?php if (isset($user)) { ?>
                    <div class="header-login  header-main_sub">
                        <p>
                            <td><img width="30px" style="height:30px;border-radius:30px;margin-right:10px" src="../upload/<?= $user['kh_avatar'] ?>" alt=""></td>
                        </p>
                        <div class="">
                            <a href="index.php?url=profile">
            ...
            <div class="header-menu padding-container">
                <ul class="header-menu_list">
                    ...
                    <li class="header-menu-item"><a href="index.php?url=gioi-thieu" class="header-menu-item-link">Giới thiệu</a>
                    </li>
                    <li class="header-menu-item"><a href="index.php?url=blog" class="header-menu-item-link">Blogs</a>
                    </li>
                    ...
                    <li class="header-menu-item"><a href="index.php?url=lien-he" class="header-menu-item-link">Liên hệ</a></li>
                </ul>
            </div>
        </header>
